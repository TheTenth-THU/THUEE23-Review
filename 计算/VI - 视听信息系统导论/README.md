...
先从 [[QUESTIONS|推免面试回忆题]] 判断问题位于采集感知、表示压缩、滤波恢复、识别理解还是生成交互环节，再回到相应章节补齐模型。复答时明确输入输出、核心假设、关键计算和评价指标，并同时考虑客观误差、人的感知质量以及部署时延。

### 08/24—09/03 冲刺安排

具体时间轴见 [[推免复习总览#08/24—09/03 冲刺计划|总计划]]。

+ **首次闭卷**：08/29 完成 Q01—Q11 全量快筛，串联采集感知、表示压缩、滤波恢复、识别理解与生成交互。
+ **集中复答**：09/01 与 MC 一起复答全部红黄题；09/02 只保留与个人项目或目标方向直接相关的视听追问。
+ **最低完成标准**：能说明输入输出、核心假设、关键计算和评价指标，并同时考虑客观误差、感知质量、部署时延与失败样例。
